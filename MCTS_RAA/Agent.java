...
public class Agent extends AbstractPlayer {
    ...
    public static List<Pair<Types.ACTIONS, Types.ACTIONS>> possiblyRedundantActions = new ArrayList();
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) {
        ...
        possiblyRedundantActions = new ArrayList();

        redundantActionList = new HashMap();
        //Create the player.
...
//        }
        ...
        System.out.println("Average Rollouts: " + average);
    ...
    public int countRedundantActions(){
        ...
        for(Pair<Types.ACTIONS, Types.ACTIONS> p: possiblyRedundantActions){
//            System.out.println(printAction(p.first)+", "+printAction(p.second));
            if(isRedundant(p.getKey(), p.getValue())){
                total = total + 1;
            }
        }
    ...
    public boolean isRedundant(Types.ACTIONS first_action, Types.ACTIONS second_action){  
        ...
        if(redundantActions != null){
            ...
            System.out.println("First: "+printAction(first_action)+", Second:"+printAction(second_action));
            return false;
        }
    ...
    public final void fecthRedundantActions(StateObservation so) {
        ...
        //for (int i = 0; i < actions.length; i++) {
            //System.out.println("Nulling actions for " + printAction(actions[i]));
            ...
            //System.out.println("Action " + printAction(actions[i]) + ": " + (fetched[i] == true ? "OK" : "Not Fetched"));
        //}
    }
